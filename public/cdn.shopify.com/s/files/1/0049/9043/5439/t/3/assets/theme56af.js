...
(function($) {
  ...
  jQuery(document).ready(function(){
    ...
    *************************************************************/
          ...
          limit: 25,
          template: '<figure class="swiper-slide"><a target="_blank" href="\{\{link\}\}" data-size="640x640"><img src="\{\{image\}\}"/></a><figcaption class="visually-hidden"><span>\{\{caption\}\}</span></figcaption></figure>',
  ...
  /*-------------------------------------
    ...
    --------------------------------------*/
  $('.thumb_carsoule_slide').owlCarousel({
    loop: false,
