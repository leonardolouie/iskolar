                        ...
                        <div class="nav-list">
                            <div class="pcoded-inner-navbar main-menu">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="pcoded active pcoded-trigger">
                                    ...
                                    <li class="pcoded-hasmenu">
                                        ...
                                        <ul class="pcoded-submenu">
                                            <li class=" pcoded">
                                                <a href="{{URL::to('products/index')}}" class="waves-effect waves-dark">
                                            ...
                                            <li class="">
                                                <a href="menu-bottom.html" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">Deactivated Products</span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li>
                                      <li class="pcoded-hasmenu">
                                        ...
                                        <a href="javascript:void(0)" class="waves-effect waves-dark">
                                            ...
                                            <span class="pcoded-mtext">Shippers</span>
                                        </a>
                                        <ul class="pcoded-submenu">
                                            <li class=" pcoded">
                                                <a href="javascript:void(0)" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">Shippers List</span>
                                                </a>
                                            </li>
                                        ...
                                        <ul class="pcoded-submenu">
                                            ...
                                            <li class="">
                                                <a href="breadcrumb.html" class="waves-effect waves-dark">
                                                    <span class="pcoded-mtext">Shoppers</span>
                                                </a>
                                            </li>
                                            <li class="">
